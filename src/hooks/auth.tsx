...
export const AuthProvider = ({ children }: AuthProvider) => {
    ...
    const token = localStorage.getItem('@idance:token');
    ...
    localStorage.setItem('@idance:token', data.token);
    localStorage.setItem('@idance:refreshToken', data.refreshToken);
    ...
    localStorage.removeItem('@idance:token');
    localStorage.removeItem('@idance:refreshToken');
